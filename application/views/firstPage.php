...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input style="width:40%" type="text" class="form-control" name="name" id="name" placeholder="Enter Name">
    </div> 
    <div class="form-group">
      <label for="email">Email:</label>
      <input style="width:40%" type="email" class="form-control" name="email" id="email" placeholder="Enter Email">
    </div>
    <div class="form-group">
      <label for="passsword">Password:</label>
      <input style="width:40%" type="text" class="form-control" name="password" id="password" placeholder="Enter Password">
      <br />
